# Robot arm movement algorithm written in Python with Numpy [![Build Status](https://travis-ci.org/JakobGM/robotarm-optimization.svg?branch=master)](https://travis-ci.org/JakobGM/robotarm-optimization)
